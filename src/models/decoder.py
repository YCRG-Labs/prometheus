"""
Convolutional Decoder for Variational Autoencoder

This module implements the decoder component of the VAE that reconstructs
32x32 spin configurations from 2D latent space representations.
"""
...
class ConvolutionalDecoder(nn.Module):
    """
    Convolutional decoder that reconstructs spin configurations from latent space.
    
    The decoder takes 2D latent vectors and progressively increases dimensionality
    through transposed convolutional layers to produce reconstructed 32x32 spin
    configurations.
    """
    ...
    def __init__(
        self,
        latent_dim: int = 2,
        output_shape: Tuple[int, int, int] = (1, 32, 32),
        ...
        Args:
            ...
            output_shape: Shape of output tensor (channels, height, width)
        ...
        self.initial_height = 4  # Start with 4x4 feature maps
