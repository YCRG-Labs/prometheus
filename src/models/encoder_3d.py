...
This module implements the 3D encoder component of the VAE that compresses
3D spin configurations into a latent space representation, extending the 2D
implementation to handle three-dimensional input data.
"""
...
class ConvolutionalEncoder3D(nn.Module):
    """
    3D Convolutional encoder that compresses 3D spin configurations to latent space.
    
    The encoder takes 3D spin configurations and progressively reduces
    dimensionality through 3D convolutional layers to produce mean and log-variance
    ...
    def __init__(
        ...
        """
        Initialize the 3D convolutional encoder.
        ...
        """
        super(ConvolutionalEncoder3D, self).__init__()
    ...
    def _calculate_flattened_size(self) -> int:
        """Calculate the size of flattened feature maps after 3D convolutions."""
        with torch.no_grad():
    ...
    def forward(self, x: torch.Tensor) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        """
        # Apply 3D convolutional layers with specified activation
        for conv_layer in self.conv_layers:
